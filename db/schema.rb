...
ActiveRecord::Schema.define(version: 2023_01_12_025833) do
  ...
  create_table "post_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["design_id"], name: "index_post_tag_relations_on_design_id"
  ...
  add_foreign_key "post_tag_relations", "designs"
